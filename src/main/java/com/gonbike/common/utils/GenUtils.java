...
import com.gonbike.common.domain.ColumnDO;
import com.gonbike.common.domain.TableDO;
...
public class GenUtils {
    ...
    /**
     * 该方法自2018年12月14日启用加入,简单实现
     * @param columnName
     * @return
     */
    private static String getColumnField(String columnName){
